...
_GROUPS = (
    ...
    ("words", "Synonyms, rhymes and word tools.", (words.setup,)),
    ...
    ("time", "Time, dates and timezones.", (timezones.setup,)),
    ("crypto", "Crypto market data (not advice).", (finance.setup,)),
    ...
    ("learning", "Self-reflection and learning (admin).", (learning.setup,)),
