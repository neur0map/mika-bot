...
- Added cases for next-turn correction adoption, temporal contradictions, DM/public and
  cross-person isolation, sensitive-data abstention, repeated-behavior activation, and stale
  candidate-inference expiry. Activation and expiry remain distinct policy lifecycles.
